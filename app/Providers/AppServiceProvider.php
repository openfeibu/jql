...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
            'App\Repositories\Eloquent\RecruitCategoryRepositoryInterface',
            \App\Repositories\Eloquent\RecruitCategoryRepository::class
        );
        $this->app->bind(
        ...
        $this->app->bind(
            'App\Repositories\Eloquent\MessageRepositoryInterface',
