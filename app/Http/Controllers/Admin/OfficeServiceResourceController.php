 ...
 */
class OfficeServiceResourceController extends BaseController
{
    /**
                                ...
                                PageCategoryRepositoryInterface $category)
    {
        ...
        $this->category_slug = $this->main_url = 'office_service';
    ...
    public function show(PageRequest $request,Page $office_service)
    {
        return parent::show($request,$office_service);
    }
    public function update(PageRequest $request,Page $office_service)
    {
        return parent::update($request,$office_service);
    }
    public function destroy(PageRequest $request,Page $office_service)
    {
        return parent::destroy($request,$office_service);
    }
