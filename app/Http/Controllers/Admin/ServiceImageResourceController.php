 ...
 */
class ServiceImageResourceController extends BaseController
{
    /**
                                ...
                                PageCategoryRepositoryInterface $category_repository)
    {
        ...
        $this->main_url = 'service_case/image';
        $this->slug = 'image';
        $this->view_floder = 'service.case.image.';
    }
    ...
    public function show(PageRequest $request,Page $image)
    {
        $page = $image;
        if ($page->exists) {
    ...
    public function update(PageRequest $request,Page $image)
    {
        $page = $image;
        try {
            $attributes = $request->all();
    ...
    public function destroy(PageRequest $request,Page $image)
    {
        $page = $image;
        try {
