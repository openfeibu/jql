            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('nav/nav/'.$nav->id)); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="slug" lay-verify="title" autocomplete="off" placeholder="请输入标识" class="layui-input" value="<?php echo e($nav->slug); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="order" lay-verify="title" autocomplete="off" class="layui-input" value="<?php echo e($nav['order']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
