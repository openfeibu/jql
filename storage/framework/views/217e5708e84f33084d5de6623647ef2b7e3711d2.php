            ...
            <div class="fb-main-table">
                <form class="layui-form" action="<?php echo e(guard_url('setting/updateCompany')); ?>" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="company_name_en" lay-verify="companyNameEN" autocomplete="off" placeholder="请输入公司英文名称" class="layui-input" value="<?php echo e($company['company_name_en']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="http" lay-verify="address" autocomplete="off" placeholder="请输入Http" class="layui-input" value="<?php echo e($company['http']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">版权声明</label>
                        <div class="layui-input-inline">
                            <input type="text" name="copyright" lay-verify="copyright" autocomplete="off" placeholder="请输入版权声明" class="layui-input" value="<?php echo e($company['copyright']); ?>">
                        </div>
                    </div>
                    <div class="layui-form-item">
