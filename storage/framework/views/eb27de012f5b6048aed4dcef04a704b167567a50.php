                ...
                <form class="layui-form" action="<?php echo e(guard_url('permission')); ?>" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="name" lay-verify="name" autocomplete="off" placeholder="请输入<?php echo e(trans('permission.label.name')); ?>" class="layui-input" value="">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"><?php echo e(trans('permission.label.slug')); ?></label>
                        <div class="layui-input-inline">
                            <input type="text" name="slug" lay-verify="slug" autocomplete="off" placeholder="请输入<?php echo e(trans('permission.label.slug')); ?>" class="layui-input" value="">
                        </div>
                    </div>
                    <div class="layui-form-item">
