        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm " data-type="add" data-events="add">增加分类</button>
...
<script>
    var main_url = "<?php echo e(guard_url('recruit/category')); ?>";
    var delete_all_url = "<?php echo e(guard_url('recruit/category/destroyAll')); ?>";
