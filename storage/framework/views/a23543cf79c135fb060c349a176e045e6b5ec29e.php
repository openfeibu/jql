            ...
            <div class="swiper-container swiper-container-v swiper-container-pc">
                <div class="swiper-wrapper">
                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $banner_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide"><div class="imgItem" style="background: url(<?php echo e(url('image/original/'.$banner_item['image'])); ?>) no-repeat center/cover"></div></div>
            ...
            <div class="part3">
                ...
                <div class="part3-con fb-position-relative">
                    <div class="part3-item part3-item1 fb-position-absolute">
                        <div class="part3-item-img  fb-delay-200ms"><a href="<?php echo e(route('wap.service')); ?>"></a></div>
                    ...
                    <div class="part3-item part3-item2 fb-position-absolute">
                        <div class="part3-item-img  fb-delay-400ms"><a href="<?php echo e(route('wap.service')); ?>"></a></div>
                    ...
                    <div class="part3-item part3-item3 fb-position-absolute">
                        <div class="part3-item-img  fb-delay-600ms"><a href="<?php echo e(route('wap.service')); ?>"></a></div>
                    ...
                    <div class="part3-item part3-item4 fb-position-absolute">
                        <div class="part3-item-img fb-delay-800ms"><a href="<?php echo e(route('wap.service')); ?>"></a></div>
            ...
            <div class="partner w1200">
                ...
                <div class="partner-con fb-clearfix fb-delay-600ms">
                    <?php $__currentLoopData = app('link_repository')->getLinksByCategory('partners'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $link_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="partner-item fb-float-left"><img src="<?php echo e(url('image/original/'.$link_item['image'])); ?>" alt="<?php echo e($link_item['name']); ?>"></div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
            ...
            <div class="contact " id="contact ">
                <div class="contact-con w1200">
                    <div class="contact-left">
                        <div class="contact-logo"><img src="<?php echo theme_asset('images/logo2.png'); ?>" alt=""></div>
                        <dl>
                            <dd>地址：<?php echo e(setting('address')); ?></dd>
                            <dd>电话：<?php echo e(setting('tel')); ?></dd>
                            <dd>QQ：<?php echo e(setting('qq')); ?></dd>
                            <dd>Http: <?php echo e(setting('http')); ?></dd>
                        </dl>
                        <div class="copy">
