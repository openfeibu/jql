        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('service_case/image/create')); ?>">添加公司案例图片</a></button>
...
<script>
    var main_url = "<?php echo e(guard_url('service_case/image')); ?>";
    var delete_all_url = "<?php echo e(guard_url('service_case/image/destroyAll')); ?>";
