        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    {{--<button class="layui-btn layui-btn-warm "><a href="{{guard_url('benefit/create')}}">添加员工福利</a></button>--}}
...
<script>
    var main_url = "{{guard_url('benefit')}}";
    var delete_all_url = "{{guard_url('benefit/destroyAll')}}";
