    ...
    <div class="main_full">
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('banner/banner/'.$banner->id)}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            @foreach($categories as $key => $category)
                                <input type="radio" name="category_id" value="{{$category['id']}}" title="{{$category['name']}}" @if($category['id'] == $banner->category_id) checked @endif>
                            @endforeach
                        </div>
                    </div>
                    <div class="layui-form-item">
