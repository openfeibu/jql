        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('service_case/service_case/create')}}">添加公司案例内容</a></button>
...
<script>
    var main_url = "{{guard_url('service_case/service_case')}}";
    var delete_all_url = "{{guard_url('service_case/service_case/destroyAll')}}";
