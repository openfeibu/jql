            ...
            <div class="swiper-wrapper">
                @foreach($banners as $key => $banner_item)
                    <div class="swiper-slide">
                        <img src="{{ url('image/original/'.$banner_item['image']) }}" alt="">
                    </div>
                @endforeach
            </div>
    ...
    <div class="part2">
        <div class="part2-con">
            ...
            <div class="part2-con-item part2-con-item1 fb-delay-400ms">
                <a href="{{ route('wap.service') }}"><img src="{!!theme_asset('images/item1.png')!!}" alt=""></a>
                <div class="test">
                    <p>定制化服务</p>
            ...
            <div class="part2-con-item part2-con-item2 fb-delay-600ms">
                <a href="{{ route('wap.service') }}"><img src="{!!theme_asset('images/item2.png')!!}" alt=""></a>
                <div class="test">
                    <p>员工福利</p>
            ...
            <div class="part2-con-item part2-con-item3 fb-delay-800ms">
                <a href="{{ route('wap.service') }}"><img src="{!!theme_asset('images/item3.png')!!}" alt=""></a>
                <div class="test">
                    <p>办公服务</p>
            ...
            <div class="part2-con-item part2-con-item4 fb-delay-1000ms">
                <a href="{{ route('wap.service') }}"> <img src="{!!theme_asset('images/item4.png')!!}" alt=""></a>
                <div class="test">
                    <p>智能售卖</p>
                    <span>INTELLIGENT  SELLING</span>
                </div>
    ...
    <div class="part3">
        ...
        <div class="partner-con fb-clearfix fb-delay-600ms">
            @foreach(app('link_repository')->getLinksByCategory('partners') as $key => $link_item)
                <div class="partner-item fb-float-left"><img src="{{ url('image/original/'.$link_item['image']) }}" alt=""></div>
            @endforeach
        </div>
    </div>
