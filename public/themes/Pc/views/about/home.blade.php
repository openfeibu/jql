...
<div class="about-part2 " style="background: url({!! url('image/original/'.$about_image) !!}) no-repeat center /1920px auto">
...
<div class="about-part4">
    ...
    <div class="about-lc w1200 fb-delay-200ms">
        ...
        <div class="about-lc-item @if($courses->count() == $i) last @endif">
            <div class="date">{{ $course_item->year }}</div>
            <div class="con"> {!! $course_item->description !!} </div>
        </div>
        <?php $i++;?>
        @endforeach
    </div>
